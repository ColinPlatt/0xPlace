...
/* MAIN ELEMENTS */
function title(html memory _html, string memory _title) pure returns (html memory) {
...
function div(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("div", _props, _children));
}

function div_(html memory _html, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("div", _children));
}

function textarea(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("textarea", _props, _children));
}

function link(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendHead(el("link", _props, _children));
}

function link_(html memory _html, string memory _children) pure returns (html memory) {
    return _html.appendHead(el("link", _children));
}

function a(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("a", _props, _children));
}

function a_(html memory _html, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("a", _children));
}

function p(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("p", _props, _children));
}

function p_(html memory _html, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("p", _children));
}

function span(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("span", _props, _children));
}

function span_(html memory _html, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("span", _children));
}

function button(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("button", _props, _children));
}

function button_(html memory _html, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("button", _children));
}

function h1(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("h1", _props, _children));
}

function h1_(html memory _html, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("h1", _children));
}

function h2(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("h2", _props, _children));
}

function h2_(html memory _html, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("h2", _children));
}

function hN(html memory _html, uint256 _n, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el(LibString.concat("h", LibString.toString(_n)), _props, _children));
}

function hN_(html memory _html, uint256 _n, string memory _children) pure returns (html memory) {
    return _html.appendBody(el(LibString.concat("h", LibString.toString(_n)), _children));
}

function script(html memory _html, string memory _props, string memory _children) pure returns (html memory) {
    return _html.appendBody(el("script", _props, _children));
}

function script_(html memory _html, string memory _children) pure returns (html memory) {
